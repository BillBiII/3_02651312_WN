...
# FOR DISCRETION: CHATGPT ACCESSED BETWEEN 25/05/26 - 03/06/2026 HAS BEEN USED TO FIND PYTHON FUNCTIONS (e.g solve_ivp) AND PYTHON PACKAGES (e.g ImageIO, SciPy).
